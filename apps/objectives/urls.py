...
from .views import objective_view, admin_objective, user_objective, create_objective, obj_cycle_create, cycle_delete, obj_cycle_edit
...
urlpatterns = [
    ...
    path('admin_objective/cycles/<int:pk>/edit/', obj_cycle_edit, name='obj_cycle_edit'),
]
