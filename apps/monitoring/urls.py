...
from .views import monitoring_view, module_panel_api, live_stats_api, user_modules_api, module_users_api
...
urlpatterns = [
    ...
    path("api/module-users/", module_users_api, name="module_users_api"),
]
